...
hi StatusLine ctermbg=Black ctermfg=White guibg=Gray75 guifg=fg gui=bold
hi StatusLineNC ctermbg=LightGray ctermfg=fg guibg=Gray65 guifg=fg gui=none
if has("spell")
...
hi VertSplit ctermbg=LightGray ctermfg=fg guibg=Gray65 guifg=fg gui=none
if version >= 700
